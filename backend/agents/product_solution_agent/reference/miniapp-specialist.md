...
HCP enters via:
    ...
    ↓ [1] Registration Form (Zalo MiniApp):
        ...
        - Consent checkboxes (agree to terms & data privacy)
        - Follow OA checkbox
        - CTA: Submit (Đăng ký)
    ↓ Successful Account Registration
    ↓ M1 — Tin ZBS xác nhận đăng ký tài khoản thành công
    ↓ [2] Home screen (Trang chủ) — 3 sections:
        ...
        │       → Register (Đăng ký)
        │       → M2 — Tin ZBS sự kiện (đường dẫn phòng họp nếu Online / mã QR cá nhân check-in nếu Offline)
        │       → M3 — Quét QR check-in sự kiện offline → Gửi tin nhắn cảm ơn/xác nhận check-in
        │       → M4 — Tin ZBS Khảo sát sau sự kiện
...
**ZBS Message Map (triggered automatically - Transactional only, no promotional messages):**
| Message | Trigger | Content |
|---|---|---|
| M1 | Đăng ký tài khoản thành công | Xác nhận đăng ký tài khoản thành công trên Hub |
| M2 | Đăng ký sự kiện thành công | Thông tin sự kiện + Đường dẫn phòng họp (Online) HOẶC Mã QR check-in cá nhân (Offline) |
| M3 | Quét QR check-in tại sự kiện offline | Tin nhắn xác nhận check-in thành công và chào mừng đến sự kiện |
| M4 | Sự kiện kết thúc | Khảo sát sau sự kiện và gửi link đánh giá |
