...
- **Translate Jargon:** Convert technical acronyms into friendly Vietnamese (e.g., Zalo OA -> Trang Zalo chính thức, ZNS -> Tin nhắn Zalo chăm sóc khách hàng, ZBS -> Hệ thống tự động hóa tin nhắn Zalo, API -> Cổng kết nối dữ liệu mở, migrate -> chuyển giao và đồng bộ dữ liệu, O2O -> Kết nối cửa hàng vật lý lên môi trường số).
